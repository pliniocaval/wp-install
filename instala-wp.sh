...
if [[ "$EUID" -ne 0 ]]; then
  echo "Error: Necessario rodar o comando como root ou com sudo."
  exit
fi
...
echo "> Minimo 8 caracteres, com letra maiucusla, minuscula, numero e carater especial"
read -s MYSQL_ROOT_PASSWORD
echo

echo "Insira a senha para o usuáro de admin do WP:"
echo "> Minimo 8 caracteres, com letra maiucusla, minuscula, numero e carater especial"
...
/* Fim da edição, pronto para subir. */
